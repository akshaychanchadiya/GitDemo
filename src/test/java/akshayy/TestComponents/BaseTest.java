package akshayy.TestComponents;
...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException
	{
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"//src//main//java//akshayy//resources//GlobalData.properties");
		prop.load(fis);
